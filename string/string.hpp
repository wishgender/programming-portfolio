...
const char NULL_CHAR = '\0';                      //Used in order to avoid "magic numbers/characters"
...
public:
            String        ();                               //Empty string
            String        (const int);                      //String of Size int
    ...
    char&   operator[]    (int);                            //Accessor/Mutator
    char    operator[]    (int)                     const;  //Accessor
    
    String& operator+=    (const String&);
    bool    operator==    (const String&)           const;
    bool    operator<     (const String&)           const;
    String  substr        (int, int)                const;  //sub from start to end position
    ...
    std::vector<String>   split  (char)             const; //splits String at the char, returning a vector<String>
    void    static printSplit    (std::vector<String>);
